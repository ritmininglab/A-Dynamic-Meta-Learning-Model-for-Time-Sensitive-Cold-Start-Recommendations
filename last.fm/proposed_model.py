...
if __name__ == "__main__":
    path = os.getcwd()
    active_user_dict = pickle.load(open("{}/user_dict_fm.pkl".format(path), "rb"))
    active_label_dict = pickle.load(open("{}/rating_dict_fm.pkl".format(path), "rb"))
    movie_dict = pickle.load(open("{}/track_dict.pkl".format(path), "rb"))
    ...
    for period in range(1, 17):
        ...
        while  epoch <= 20:
            ...
            if period>1:
                ...
                for user in tt_user:
                    ...
                    hidden_r = torch.reshape(hidden_r, (1, 96))
                ...
                if epoch % 2 == 0:
                    print('RNN loss at epoch {}={}'.format(epoch,math.log2( rn_los)))
            ...
            if epoch % 2 == 0:
                print('Meta Training Loss for epoch {}= {}'.format(epoch, math.log2(t_loss)))
        ...
        print('\nMeta Test Loss at period {} = {}\n'.format(period, math.log2(t_loss)))
        ...
        for per in range(1,10):
            ...
            rmse_result.append(math.log2(rms))
        print(rmse_result)
